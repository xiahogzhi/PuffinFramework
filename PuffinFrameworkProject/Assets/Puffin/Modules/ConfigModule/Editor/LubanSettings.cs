...
namespace Puffin.Modules.ConfigModule.Editor
{
    ...
    {
        private const string SettingsPath = "Assets/Puffin/Modules/ConfigModule/Editor/LubanSettings.asset";
        ...
        public string outputCodeDir = "../Assets/Puffin/Modules/ConfigModule/Runtime/Generate";

        [Tooltip("数据输出目录（相对于 Luban 目录）")]
        public string outputDataDir = "../Assets/Puffin/Modules/ConfigModule/Resources";
